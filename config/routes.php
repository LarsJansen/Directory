...
return static function ($router) {
    ...
    $router->get('/editor/categories/{id}/merge', [EditorCategoryController::class, 'merge']);
    $router->post('/editor/categories/{id}/merge', [EditorCategoryController::class, 'mergeUpdate']);
    $router->get('/editor/categories/{id}/delete', [EditorCategoryController::class, 'delete']);
    ...
    $router->post('/editor/sites/dead/deactivate-all', [EditorSiteController::class, 'deactivateAllDead']);
    ...
    $router->post('/editor/sites/{id}/quick-action', [EditorSiteController::class, 'quickAction']);
