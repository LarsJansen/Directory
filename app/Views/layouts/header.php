...
<head>
    ...
    <!-- FAVICONS -->
    <link rel="icon" type="image/png" sizes="32x32" href="<?= e(base_url('/assets/favicon-32.png')) ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= e(base_url('/assets/favicon-16.png')) ?>">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center gap-2" href="<?= e(base_url('/')) ?>">
            <img src="<?= e(base_url('/assets/logo.png')) ?>" alt="Internet History Directory" height="36">
        </a>
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link<?= $currentPath === '/' ? ' active' : '' ?>" href="<?= e(base_url('/')) ?>"><?= e(config('name')) ?></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link<?= str_starts_with($currentPath, '/category') ? ' active' : '' ?>" href="<?= e(base_url('/category')) ?>">Browse</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link<?= str_starts_with($currentPath, '/submit') ? ' active' : '' ?>" href="<?= e(base_url('/submit')) ?>">Submit Site</a>
                </li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle<?= str_starts_with($currentPath, '/pages') ? ' active' : '' ?>" href="#" id="pagesDropdown" role="button" data-bs-toggle="dropdown">
                        Pages
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link<?= str_starts_with($currentPath, '/editor') ? ' active' : '' ?>" href="<?= e(base_url('/editor')) ?>">Editor</a>
                </li>

            </ul>

            <!-- SEARCH -->
            <form class="d-flex" method="get" action="<?= e(base_url('/search')) ?>" role="search">
